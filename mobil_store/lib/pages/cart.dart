...
class HesapVarCart extends StatefulWidget {
  const HesapVarCart({super.key});

  @override
  State<HesapVarCart> createState() => _HesapVarCartState();
}

class _HesapVarCartState extends State<HesapVarCart> {
...
class HesapYokCart extends StatefulWidget {
  const HesapYokCart({super.key});

  @override
  State<HesapYokCart> createState() => _HesapYokCartState();
}

class _HesapYokCartState extends State<HesapYokCart> {
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 20),
          Text(
            'Sepetinizi görüntüleyebilmek için lütfen giriş yapın. Beğendiğiniz ürünleri sepetinize ekleyebilirsiniz',
            style: TextStyle(
