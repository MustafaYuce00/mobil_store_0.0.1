...
import 'package:mobil_store/login/src/widgets/term_of_service_checkbox.dart';
      ...
      inputField = Padding(
        ...
        child: InternationalPhoneNumberInput(
          ...
          searchBoxDecoration: const InputDecoration(
            ...
            labelText: 'Ülke adına veya arama koduna göre arama',
          ),
      ...
      suffixIcon: GestureDetector(
        ...
        child: AnimatedCrossFade(
          ...
          firstChild: const Icon(
            Icons.visibility,
            size: 25.0,
            semanticLabel: 'parola göster',
          ),
          secondChild: const Icon(
            Icons.visibility_off,
            size: 25.0,
            semanticLabel: 'parolayı gizle',
          ),
